...
if(isset($_GET['delid'])){
    ...
    $sql =mysqli_query($conn,"DELETE FROM momentsadmin WHERE id='$id'");
    echo"<script>alert('Employee has been succesfully deleted!!');</script>";
...
<nav class="navbar navbar-light bg-light fixed-top">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>Employee List</h3>
                | <a href="generate_pdf.php" class="btn btn-danger"> PDF </a>
                | <button type="submit" onClick="Export()">Excel</button>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody id="myTable">
                        ...
                        $result_count=mysqli_query($conn,"SELECT COUNT(*) as total_records FROM momentsadmin");
                        ...
                        $second_last = $total_no_of_pages - 1;
                            ...
                            $sql = mysqli_query($conn,"SELECT * FROM momentsadmin ORDER by firstname LIMIT $offset,$total_records_per_page");
                            $count =1;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp
                                <a href="index.php?delid=<?php echo htmlentities($row['id']);?>" onclick ="return confirm ('Do you relly want to remove this employee?')" class="btn btn-danger btn-sm"> <span class="glyphicon glyphicon-trash"></span>Delete</a>
                                </div>
