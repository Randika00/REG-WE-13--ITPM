...
<head>
    ...
    <body>
        ...
        <br/>
            ...
            <h1 class="fs-2 mt-5">View Order Details</h1>
                ...
                <tbody id="output">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="ordUpdate.php?id=<?php echo $row['id']; ?>">Update</a>&nbsp;<a class="btn btn-danger" href="ordDelete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                            </tr>
         ...
         <div>
         <a href= "ordReport.php" >  
	       <input type="submit" style="float:right; margin: 20px 250px 0px 0px;" class="btn btn-primary" value="Search Orders" name="Serach Orders">
                      </a>
         </div>
